...
import AreaPincodeModal, { AreaItem } from '../modals/AreaPincodeModal';
...
export default function Navbar() {
  ...
  const count = selectedPincodes ? selectedPincodes.length : 1;
  const displayLocation = count > 1 ? `${selectedCity} (${count} Pincodes)` : selectedCity;
