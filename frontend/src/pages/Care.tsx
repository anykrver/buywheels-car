...
export default function Care() {
  ...
  return (
    <div className="min-h-screen bg-surface pt-24 pb-24 lg:pb-12">
      <PageSEO
        title="BuyWheels Care Plan | 24x7 Roadside Assistance & Service Reminders Jharkhand"
        description="Comprehensive post-purchase care for your vehicle in Ranchi, Jamshedpur and Jharkhand. 24/7 towing, service reminders, warranty support, and cashless insurance claims."
        canonicalPath="/care"
      />
      {/* Hero */}
