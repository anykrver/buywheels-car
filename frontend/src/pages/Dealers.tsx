...
const DEALERS_LOCALBUSINESS_JSONLD = {
  '@context': 'https://schema.org',
  '@type': 'AutoDealer',
  name: 'BuyWheels Dealer Network Jharkhand',
  description: 'Authorized Maruti, Hyundai, Tata, Mahindra & Honda car dealerships across Ranchi, Jamshedpur, Dhanbad, Bokaro and Hazaribagh.',
  areaServed: {
    '@type': 'State',
    name: 'Jharkhand'
  },
...
export default function Dealers() {
  ...
  return (
    <div className="min-h-screen bg-surface pt-24 pb-24 lg:pb-12">
      <PageSEO
        title="Authorised Car Dealers in Jharkhand | Maruti, Hyundai, Tata, Mahindra Showrooms | BuyWheels"
        description="Find 50+ authorised car dealerships in Ranchi, Jamshedpur, Dhanbad, Bokaro and Hazaribagh. Get showroom addresses, phone numbers, opening hours, and test drive booking."
        canonicalPath="/dealers"
        jsonLd={DEALERS_LOCALBUSINESS_JSONLD}
      />
      {/* Hero */}
