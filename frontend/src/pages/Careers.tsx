...
export default function Careers() {
  ...
  return (
    <div className="min-h-screen bg-surface pt-24 pb-24 lg:pb-12 animate-fade-in">
      <PageSEO
        title="Careers at BuyWheels | Join Jharkhand's Fast-Growing Auto Tech Team"
        description="Explore open career opportunities at BuyWheels in Ranchi. We are hiring Sales Consultants, Dealer Managers, Customer Support and Frontend Developers."
